...
<template>
  <div class="bg-base-1 border-edge-strong my-1 mx-1.5 border p-2.5 text-sm">
    ...
    <div class="mt-2 flex justify-end gap-2">
      ...
      <button
        class="text-primary bg-surface-1 border-edge border px-2.5 py-1 text-xs font-medium outline-none"
        :disabled="!text.trim()"
